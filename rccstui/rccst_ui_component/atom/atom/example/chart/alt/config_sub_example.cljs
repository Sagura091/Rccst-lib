(ns rccstui.rccst-ui-component.atom.example.chart.alt.config-sub-example
...
(log/info "rccstui.rccst-ui-component.atom.example.chart.bar-chart.data-sub-example")
