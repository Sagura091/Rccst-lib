(ns rccstui.rccst-ui-component.atom.example.chart.sankey-chart
  (:require [ui-component.atom.chart.sankey-chart :as chart]
...
(log/info "rccstui.rccst-ui-component.atom.example.chart.sankey-chart-2")
