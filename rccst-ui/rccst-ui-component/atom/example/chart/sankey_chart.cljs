(ns rccst-ui-component.atom.example.chart.sankey-chart
  (:require [bh.ui-component.atom.chart.sankey-chart :as chart]
...
(log/info "rccst-ui-component.atom.example.chart.sankey-chart-2")
